...
export default function TestimonialCarousel() {
    ...
    return (
        ...
        <h1 className='uppercase text-2xl text-secondary mt-10 font-semibold ml-4'>Reviews: 14</h1>
        <Swiper
            slidesPerView={"auto"}
            spaceBetween={30}
            pagination={true}
                ...
                <div className="container py-10 mx-auto ">
                    <div className="flex flex-wrap -m-4">
                        <div className="p-4 w-full">
                            <div className="h-full bg-gray-100 shadow-lg  p-8 rounded border-r-2 border-secondary">
                                <svg
                                
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="currentColor"
                                    className="block w-5 h-5 text-secondary mb-4"
                                ...
                                <a className="inline-flex items-center">
                                    <Image
                                        ...
                                        className="w-12 h-12 rounded-full flex-shrink-0 object-cover border border-secondary p-2 object-center"
                                    />
                                    <span className="flex-grow flex flex-col pl-4">
                                        ...
                                        <span className="title-font font-semibold text-secondary">
                                            Raisul Kabir
                                        </span>
                                    </span>
                                </a>
